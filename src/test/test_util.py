...
class NodeATestCase(unittest.TestCase):
    ...
    def test_crop_image(self):
        ...
        cropped_image_path = "/workspace/wfp-01-03-02/src/test/output.tif"
    ...
    def test_crop_image_remote_gzip(self):
        polygon = 'POLYGON((-30 -10, 20 -10, 20 40, -30 40, -30 -10))'
        image_url = 'ftp://ftp.chg.ucsb.edu/pub/org/chg/products/CHIRPS-2.0/global_daily/tifs/p05/2018/chirps-v2.0.2018.09.28.tif.gz'
